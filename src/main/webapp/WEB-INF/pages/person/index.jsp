...
<div class="pageHeader">
    <form onsubmit="return navTabSearch(this);" action="${ctx}/person/index" method="post" onreset="$(this).find('input').val()">
        <div class="searchBar">
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" href="${ctx}/person/pop/modify" target="dialog" mask="true"><span>新增</span></a></li>
            <li class="line">line</li>
            <li><a class="icon" href="${ctx}/person/template/download" target="dwzExport" targetType="navTab" title="下载导入模版?"><span>下载导入模版</span></a></li>
            <li><a class="icon" href="${ctx}/person/pop/upload" target="dialog" title="导入人员?"><span>导入人员</span></a></li>
        </ul>
    </div>
            ...
            <tr>
                ...
                <td>
                    <div>
                        ...
                        <a target="dialog"  href="${ctx}/person/pop/modify?id=${person.id}" class="">修改</a>
                    </div>
                </td>
            </tr>
        </c:forEach>
