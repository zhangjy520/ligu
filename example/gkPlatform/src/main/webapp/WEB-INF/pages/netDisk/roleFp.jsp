	...
	<div class="row" id="js-manage">
		...
		<main class="col-sm-9">
			<div class="rolls-distribute-add">
				<button class="add-btn" onclick="openDialog('添加用户','${ctx}/renshi/roleuser/add?roleId=${currentRole}','500px','352px')">添加用户</button>
			</div>
...
<script>
	...
	$(function() {
		...
		$(".fenY").createPage({
			...
			backFn:function(p){
				window.location.href = "${ctx}/net/disk/rolefp/index?pageNum="+p+"&pageSize=10";
			}
		});
		...
		$(".gotoPage").click(function (){
			...
			if (pageNum <= 0 || pageNum > ${pageInfo.pages}){
				...
				window.location.href = "${ctx}/net/disk/rolefp/index?pageNum="+$(".go").val()+"&pageSize=10";
			}
		});
		</c:if>
	...
	var zNodes1 =[
		{id:0, pId:-1, name:"教师云盘", open:true},
	...
	$(".node_name").click(function () {
		window.location.href="${ctx}/net/disk/rolefp/index?pageSize=10&roleId="+$(this).attr("menuId");
	});
