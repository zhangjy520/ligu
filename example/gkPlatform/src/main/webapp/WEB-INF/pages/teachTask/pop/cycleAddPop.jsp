...
<script>
    function doSubmit() {
        ...
        if (!isEmpty(cycleYear) || !isEmpty(cycleSemester)|| !isEmpty(start) || !isEmpty(end) || !isEmpty(weekCount)
                || !isEmpty(termsStart)) {
            return;
        }
        ...
        $.post("${ctx}/teach/task/cycle/do", {
            id: removeAllTrim('${teachCycle.id}'),
            type: removeAllTrim('${type}'),
            beginDate: removeAllTrim(start),
            endDate: removeAllTrim(end),
            weekCount: removeAllTrim(weekCount),
            synInfo: removeAllTrim(synInfo),
            cycleId: removeAllTrim(cycleId),
