            ...
            <div class="rolls-distribute-add">
                <button class="add-btn"
                        onclick="openDialog('添加用户',
                                '${ctx}/area/role/add/page?roleId=${currentRole}&&appId=${appId}','500px','352px');">
                    添加用户
                </button>
            </div>
            <table class="table-responsive">
                <thead>
                <style>table th:nth-child(1), table td:nth-child(1) {
                    text-align: center;
                }</style>
                <tr>
                    <th width="8%">序号</th>
...
<script>
    ...
    var zNodes1 = [
        {id: 0, pId: -1, name: "教务管理", open: true},
    ...
    $(".node_name").click(function () {
        window.location.href = "${ctx}/area/role/manage/index?pageSize=10&roleId=" + $(this).attr("menuId");
    });
