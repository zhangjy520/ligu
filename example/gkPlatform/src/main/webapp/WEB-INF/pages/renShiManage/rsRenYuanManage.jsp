...
<main class="container" id="ry-manage">
    <div class="search-box">
        <div class="roll-operation">
            <button class="roll-add" onclick="openDialog('新增职工','${ctx}/renshi/renyuan/edit','900px','70%')">新增
            </button>
    ...
    $(function () {
        ...
        $(".fenY").createPage({
            ...
            backFn: function (p) {
                ...
                window.location.href = "${ctx}/renshi/renyuan/index?pageNum=" + p + "&teacherName=" + encodeURI(encodeURI(name));
        ...
        $(".gotoPage").click(function () {
            ...
            if (pageNum <= 0 || pageNum >${pageInfo.pages}) {
                ...
                window.location.href = "${ctx}/renshi/renyuan/index?pageNum=" + $(".go").val() + "&teacherName=" + encodeURI(encodeURI(name));
            }
        });
