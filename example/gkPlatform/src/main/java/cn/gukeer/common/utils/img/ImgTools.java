package cn.gukeer.common.utils.img;
...
public class ImgTools {
    ...
    public static void main(String[] args) throws IOException {
        File img = new File("/home/alpha/Desktop/40.jpg");
        FileOutputStream fos = new FileOutputStream("/home/alpha/Desktop/222.jpg");
        BufferedImage bi = ImageIO.read(img);
        img.length();
        int srcWidth = bi.getWidth(); // 源图宽度
        int srcHeight = bi.getHeight(); // 源图高度
        ...
        ImgTools.thumbnail_w_h(img, srcWidth, 0, fos);
    }
