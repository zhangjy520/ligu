...
public class ConverVideoUtils {
    ...
    private String ffmpegpath = (String) properties.get("ffmpegpath"); // ffmpeg.exe的目录
    ...
    public boolean processImg(String sourceVideoPath) {
        ...
        commend.add("image2");
        commend.add("-y");
        commend.add(imageRealPath + filerealname + properties.get("screenshotTargetExtension"));
        try {
