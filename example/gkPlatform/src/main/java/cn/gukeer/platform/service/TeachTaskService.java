...
public interface TeachTaskService {
    ...
    PageInfo<TeachCycle> getCyclePageInfo(int pageNum,int pageSize,String schoolId);

    int saveTeachCycle(TeachCycle teachCycle, List<ClassRoom> classRoomList,List<RefRoomCycle> refRoomCycleList,List<Course> courseList,
   ...
   * */
    ...
    * */
    ...
    //查询所有
    PageInfo<CourseType> findAllCourseType(String schoolId);
/////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
    *     课程方法
    *
    * */
    ...
    //查询所有
    PageInfo<CourseView> getAllCourseListByParam(int pageNum,int pageSize,String schoolId,String cycleId);
    ...
    //课程编辑授课班级功能的方法
    int updateCourseClassByPrimareyKey(CourseClass courseClass,String cycleId,List<TeachTable> teachTableList);
...
//    void batchSaveCourseNode(List<CourseNode> courseNodeList);
    ...
    PageInfo<TeachTableView> findTeachTableByCurrentCycleWeekAndSchoolId(String schoolId,Long currentweek, Integer pageNum, Integer pageSize, String classId, List<Integer> nodeList, String cycleId);
    ...
    List<ClassRoom> findCascadeClassRoom(String flag, String schoolTypeId, String building, String floor, String schoolId,String cycleId);
    ...
    int delCourseClassByCourseIdAndClassId(String courseId, String oldbanjineedDel,String cycleId,List<String> oldBanji);

    List<ClassRoom> findClassRoomBySchoolType(String schoolTypeId,String building);
    ...
    //更新某个周期的所有课表推送状态（因为有触发器，所以空更新即可）
    public void updateTeachTableByCycleForPush(String cycleId);

    List<CourseClass> findCourseClassByCourseIdAndXdIdAndNj(String courseId, String nj, String xdId);

    List<TeachTable> selectCourseTableByCycleIdCourseIdClassId(String cycleId, String classId, String courseId,List<String> oldBanji);

    int findClassRoom(ClassRoom room,User user);
