...
public class TeacherServiceImpl extends BasicService implements TeacherService {
    ...
    @Override
    public List<Teacher> findTeacherByRoleIdAndSchoolId(String roleId, String schoolId) {

        List<Teacher> teachers = a_userExtensionMapper.findTeacherByRoleIdAndSchoolId(roleId, schoolId);
        return teachers;
    }
