...
public class School implements Serializable {
    ...
    public void setMysqlUser(String mysqlUser) {
        this.mysqlUser = mysqlUser == null ? null : mysqlUser.trim();
    }
    ...
    public void setMysqlPwd(String mysqlPwd) {
        this.mysqlPwd = mysqlPwd == null ? null : mysqlPwd.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getMysqlUrl() == null ? other.getMysqlUrl() == null : this.getMysqlUrl().equals(other.getMysqlUrl()))
            && (this.getMysqlUser() == null ? other.getMysqlUser() == null : this.getMysqlUser().equals(other.getMysqlUser()))
            && (this.getMysqlPwd() == null ? other.getMysqlPwd() == null : this.getMysqlPwd().equals(other.getMysqlPwd()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getMysqlUrl() == null) ? 0 : getMysqlUrl().hashCode());
        result = prime * result + ((getMysqlUser() == null) ? 0 : getMysqlUser().hashCode());
        result = prime * result + ((getMysqlPwd() == null) ? 0 : getMysqlPwd().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", mysqlPwd=").append(mysqlPwd);
